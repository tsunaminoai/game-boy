...
pub const Instructions = [256]Instruction{
    ...
    .{ .opcode = 0x03, .name = "INC BC", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .BC, .destination = .BC },
    .{ .opcode = 0x04, .name = "INC B", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .B, .destination = .B },
    ...
    .{ .opcode = 0x0B, .name = "DEC BC", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .BC, .destination = .BC },
    .{ .opcode = 0x0C, .name = "INC C", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .C, .destination = .C },
    .{ .opcode = 0x0D, .name = "DEC C", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .C, .destination = .C },
    .{ .opcode = 0x0E, .name = "LD C,d8", .length = 2, .cycles = 8, .addressing = .immediate, .category = .byteLoad, .source = .C, .destination = .C },
    ...
    .{ .opcode = 0x13, .name = "INC DE", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .DE, .destination = .DE },
    .{ .opcode = 0x14, .name = "INC D", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .D, .destination = .D },
    .{ .opcode = 0x15, .name = "DEC D", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .D, .destination = .D },
    ...
    .{ .opcode = 0x1B, .name = "DEC DE", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .DE, .destination = .DE },
    .{ .opcode = 0x1C, .name = "INC E", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .E, .destination = .E },
    .{ .opcode = 0x1D, .name = "DEC E", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .E, .destination = .E },
    ...
    .{ .opcode = 0x23, .name = "INC HL", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .HL, .destination = .HL },
    .{ .opcode = 0x24, .name = "INC H", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .H, .destination = .H },
    .{ .opcode = 0x25, .name = "DEC H", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .H, .destination = .H },
    ...
    .{ .opcode = 0x2B, .name = "DEC HL", .length = 1, .cycles = 8, .addressing = .none, .category = .wordMath, .source = .HL, .destination = .HL },
    .{ .opcode = 0x2C, .name = "INC L", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .L, .destination = .L },
    .{ .opcode = 0x2D, .name = "DEC L", .length = 1, .cycles = 4, .addressing = .none, .category = .byteMath, .source = .L, .destination = .L },
    ...
    .{ .opcode = 0xEA, .name = "LD (a16),A", .length = 3, .cycles = 16, .addressing = .absolute, .category = .byteLoad, .source = .A },
    ...
    .{ .opcode = 0xED, .name = "ILLEGAL", .length = 1, .cycles = 0, .addressing = .none, .category = .illegal },
    ...
    // 0xFX
    .{ .opcode = 0xF0, .name = "LDH A,(a8)", .length = 2, .cycles = 12, .addressing = .absolute, .category = .byteLoad, .source = .HL, .destination = .A },
